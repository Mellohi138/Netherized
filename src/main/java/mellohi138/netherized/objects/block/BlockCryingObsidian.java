		...
		if (rand.nextInt(5) == 0) {
			...
			if (side != EnumFacing.UP) {
				...
				if (!stateIn.isTopSolid() || !blockstate.isSideSolid(worldIn, blockPos, side.getOpposite())) {
	                ...
	                Netherized.PROXY.spawnParticle(EnumNetherizedParticles.CRYING_OBSIDIAN_TEAR.getParticleName(), (double)pos.getX() + d0, (double)pos.getY() + d1, (double)pos.getZ() + d2, 0.0D, 0.0D, 0.0D);
				}
			}   
		}
    }
